...
import { UtensilsCrossed, Edit2, Lock, Info, Bell, HelpCircle, Shield, ChevronRight, User as UserIcon } from '../components/icons';
          ...
          <View style={styles.userInfo}>
            {user?.photoURL ? (
              ...
              <View style={[styles.avatarPlaceholder, { backgroundColor: colors.border }]}>
                <UserIcon size={32} color={colors.secondaryText} />
              </View>
            )}
