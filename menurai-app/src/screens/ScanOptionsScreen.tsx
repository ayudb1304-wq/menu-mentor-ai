...
import { Camera as CameraIcon, ImageIcon, CheckCircle2, X, History as HistoryIcon, UtensilsCrossed, Info, XCircle } from '../components/icons';
    ...
    <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      >
        ...
        <Button
          ...
          icon={<CameraIcon size={20} color={Colors.white} />}
          fullWidth
        ...
        <Card style={styles.tipsCard}>
          ...
          <View style={styles.tipRow}>
            <CheckCircle2 size={16} color={Colors.brand.green} />
                      ...
                      <View style={styles.recentCardContent}>
                        ...
                        <View style={styles.recentStats}>
                          <View style={styles.statBadge}>
                            <CheckCircle2 size={14} color={Colors.semantic.compliant} />
        ...
        <View style={styles.modalOverlay}>
          <View style={[styles.modalContent, { backgroundColor: colors.card }]}>
            ...
            <View style={styles.optionsContainer}>
              <OptionCard
                icon={<CameraIcon size={32} color={Colors.brand.blue} />}
                title="Take Photo"
