...
import { Card, LoadingOverlay, WebIcon } from '../components';
        ...
        >
          <View style={styles.scanHeader}>
            ...
            <TouchableOpacity onPress={() => handleDeleteScan(item.id)}>
              <WebIcon name="trash-2" size={20} color={colors.secondaryText} />
            </TouchableOpacity>
          </View>

          <View style={styles.scanStats}>
            <View style={styles.statItem}>
              <WebIcon name="check-circle" size={16} color={Colors.semantic.compliant} />
              <Text style={[styles.statText, { color: Colors.semantic.compliant }]}>
                {compliant}
              </Text>
            </View>
            <View style={styles.statItem}>
              <WebIcon name="info" size={16} color={Colors.semantic.modifiable} />
              <Text style={[styles.statText, { color: Colors.semantic.modifiable }]}>
                {modifiable}
              </Text>
            </View>
            <View style={styles.statItem}>
              <WebIcon name="cancel" size={16} color={Colors.semantic.nonCompliant} />
    ...
    <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]}>
      {history.length === 0 ? (
        <View style={styles.emptyState}>
          <WebIcon name="history" size={64} color={colors.secondaryText} />
